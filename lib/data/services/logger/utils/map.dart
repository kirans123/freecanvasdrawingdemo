...
extension MapExtensions on Map {
  ...
  bool getBool(String key, {bool defaultValue = defaultBool}) {
    ...
    debugPrint("Map.getBool[$key] has incorrect data : ${this[key]}");
    return defaultValue;
  }
  ...
  int getInt(String key, {int defaultValue = defaultInt}) {
    ...
    debugPrint("Map.getInt[$key] has incorrect data : ${this[key]}");
    return defaultValue;
  }
  ...
  double getDouble(String key, {double defaultValue = defaultDouble}) {
    ...
    debugPrint("Map.getDouble[$key] has incorrect data : ${this[key]}");
    return defaultValue;
  }
  ...
  String getString(String key, {String defaultValue = defaultString}) {
    ...
    debugPrint("Map.getString[$key] has incorrect data : ${this[key]}");
    return defaultValue;
  }
  ...
  Map getMap(String key) {
    ...
    debugPrint("Map.getMap[$key] has incorrect data :  ${this[key]}");
    return defaultMap;
  }
